...
struct custom_packet buildPacket(struct ether_header *etherH,struct ether_arp *arpH){

        struct ether_header ether;
        struct ether_arp arp;
        ether.ether_type = etherH->ether_type;
        *ether.ether_dhost = etherH->ether_shost;
}
